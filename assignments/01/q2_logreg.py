""" Assigment 1 - Problem 2: Logistic regression.
"""
import os
...
w = tf.get_variable('weights', shape=(784, 10), initializer=tf.random_normal_initializer(mean=0, stddev=0.01))
b = tf.get_variable('bias', initializer=tf.constant(0.0))


#Step 3: create weights and bias TODO: adding hidden layer!
...
h1 = tf.nn.sigmoid(out1, name = 'sigmoid_layer')
